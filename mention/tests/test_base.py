...
class TestAppDataAPI(unittest.TestCase):
    ...
    def test_query_error(self, mock_requests_get):
        ...
        response = type(
            "response", (object,), {"text": json.dumps(unsuccessful_response)}
        )
    ...
    def test_query_success(self, mock_requests_get):
        ...
        response = type(
            "response", (object,), {"text": json.dumps(successful_response)}
        )
...
class TestCreateAnAlertAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.CreateAnAlertAPI(
            self.access_token, self.account_id, self.name, self.queryd, self.languages
        )
...
class TestFetchAlertsAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.FetchAlertsAPI(self.access_token, self.account_id)
...
class TestUpdateAnAlertAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.UpdateAnAlertAPI(
            self.access_token,
            self.account_id,
            self.alert_id,
            self.name,
...
class TestFetchAnAlertAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.FetchAnAlertAPI(
    ...
    def test_query_alert_id_error(self, mock_requests_get):
        ...
        unsuccessful_response = {
            "code": 404,
            "message": "This alert doesn’t exist or you are not allowed to access it",
        }
    ...
    def test_query_success(self, mock_requests_get):
        ...
        self.assertEqual(
            successful_response["alert"]["name"], self.client.query()["alert"]["name"]
        )
...
class TestFetchAMentionAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.FetchAMentionAPI(
            self.access_token, self.account_id, self.alert_id, self.mention_id
        )
...
class TestFetchAllMentionsAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.FetchAllMentionsAPI(
            self.access_token, self.account_id, self.alert_id
        )
    ...
    def test_query_success(self, mock_requests_get):
        ...
        self.assertEqual(
            successful_response["mentions"][0]["original_url"],
...
class TestFetchMentionChildrenAPI(unittest.TestCase):
    ...
    def test_url(self):
        result = self.client.url
        expected = (
            "https://api.mention.net/api/accounts/b/alerts/"
...
class TestCurateAMentionAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.CurateAMentionAPI(
            self.access_token, self.account_id, self.alert_id, self.mention_id
        )
    ...
    def test_query_success(self, mock_requests_get):
        ...
        self.assertEqual(
            successful_response["mention"]["description"],
...
class TestMarkAllMentionsAsReadAPI(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = mention.MarkAllMentionsAsReadAPI(
            self.access_token, self.account_id, self.alert_id
        )
    ...
    def test_url(self):
        result = self.client.url
        expected = (
            "https://api.mention.net/api/accounts/b/alerts/c/mentions/" "markallread"
        )
