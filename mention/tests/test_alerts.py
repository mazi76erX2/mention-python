...
def test_create_basic_alert_success(
    ...
    Verifies that the API call is made with the correct parameters and returns the expected response.
    """
...
def test_create_advanced_alert_success(
    mock_oauth_session: OAuth2Session, advanced_alert_data: Dict[str, Any]
) -> None:
    """
...
def test_create_alert_with_optional_params(
    ...
    Verifies that the API call is made with the correct parameters including optional fields.
    """
    api = CreateAnAlertAPI(
        mock_oauth_session,
        "account123",
...
def test_create_alert_http_error(
    ...
    """
    Tests the behavior of the API when an HTTP error occurs during alert creation.

    Verifies that the API returns an empty dictionary in case of an HTTP error.
    """
...
def test_create_alert_empty_query(
    ...
    """
    Tests the behavior of the API when an empty query is provided.
    """
    api = CreateAnAlertAPI(
        mock_oauth_session,
        "account123",
...
def test_create_alert_invalid_language(
    ...
    """
    Tests the behavior of the API when an invalid language code is provided.

    Verifies that the API raises a ValueError exception if an invalid language code is passed.
    """
